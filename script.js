...
(function () {
  ...
  function buildLeafPositions() {
    ...
    for (var li = 0; li < layers.length; li++) {
      ...
      for (var i = 0; i < count; i++) {
        ...
        points.push({ x: sx, y: sy, size: rand(9, 15), layer: layerScale });
      }
    }
    // bloom outward: innermost ring of the heart opens first, like a
    // flower unfurling, with a touch of randomness so it feels alive
    points.sort(function (a, b) { return (a.layer - b.layer) + rand(-0.06, 0.06); });
    return points;
  }
  ...
  function beginGrowth() {
    ...
    setTimeout(function () {
      ...
      var growthDuration = positions.length * 11 + 900;
